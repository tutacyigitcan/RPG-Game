...
public class EnemyController : MonoBehaviour
{
    ...
    private float enemyTopPlayerDistance;
    ...
    void Update()
    {
        ...
        {
            enemy_CurrentState = SetEnemyState(enemy_CurrentState,enemyLastState,enemyTopPlayerDistance);
            ...
            else
            {
                ...
                } else if(!anim.IsInTransition(0)&& anim.GetCurrentAnimatorStateInfo(0).IsName("Atk1") || anim.GetCurrentAnimatorStateInfo(0).IsName("Atk2"))
                {
        ...
        else
        {
            ...
            if(!anim.IsInTransition(0) && anim.GetCurrentAnimatorStateInfo(0).IsName("Death") && anim.GetCurrentAnimatorStateInfo(0).normalizedTime >=.95f)
            {
    ...
    void GetStateControl(EnemyState curState)
    {
        ...
        else if(curState == EnemyState.WALK)
        {
            ...
            if(Vector3.Distance(transform.position,whereTo_Navigate) <= 2f)
            {
                ...
                whereTo_Navigate.z = Random.Range(initialPosition.x - 5f, initialPosition.z + 5f);
            }
            else
            {
