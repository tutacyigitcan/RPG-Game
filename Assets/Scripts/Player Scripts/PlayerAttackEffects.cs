...
public class PlayerAttackEffects : MonoBehaviour
{
    ...
    public GameObject groundImpact_Prefab, kickFX_Prefab, fireTornada_Prefab, fireShiled_Prefab, healFX_Prefab, thunderFX_Prefab;
    ...
    void FireTornado()
    {
        Instantiate(fireTornada_Prefab, fireTornado_Spawn.transform.position, Quaternion.identity);
    }

    void FireShield()
    {
        GameObject fireObj = Instantiate(fireTornada_Prefab, fireShield_Spawn.transform.position, Quaternion.identity) as GameObject;
